            ...
            <ul>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
						<li class="submenu">
							<a href="javascript:void(0);"
								class="{{ Request::is('product-list', 'low-stocks', 'category-list', 'sub-categories', 'brand-list', 'varriant-attributes') ? 'active subdrop' : '' }}"><i
									data-feather="key"></i><span>Products</span><span
									class="menu-arrow"></span></a>
							<ul>
								...
								<li class="{{ Request::is('varriant-attributes') ? 'active' : '' }}"><a
									href="{{ url('varriant-attributes') }}"><i data-feather="layers"></i><span>Variant Attributes</span></a></li>
								</li>
                    		</ul>
						</li>
					</ul>
